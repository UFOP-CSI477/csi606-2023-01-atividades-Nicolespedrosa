        ...
        <main className="container m-auto">
            ...
            <form onSubmit = {handleSubmit}>
                ...
                <div>
                    ...
                    <Input name="nome" setValue={(event) => {setNome(event.target.value)}}/>
                </div>
                <div>
                    <label htmlFor="sigla">Sigla</label>
                    <Input name="sigla" placeholder="Informe a sigla da Unidade Federativa" setValue={(event) => {setSigla(event.target.value)}}/>
                </div>
                <div>
